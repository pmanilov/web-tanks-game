package com.manilov.gdx.game.client.dto;

import com.manilov.gdx.game.InputState;
...
public class InputStateImpl implements InputState {
    ...
    public InputStateImpl(boolean leftPressed, boolean rightPressed, boolean upPressed, boolean downPressed, boolean firePressed, float angle, float angleBody) {
        this();
        ...
        setAngle(angle);
        setAngleBody(angleBody);
    }

    @Override
    public native float getAngleBody() /*-{
        return this.angleBody;
    }-*/
    ;
    @Override
    public native void setAngleBody(float angleBody) /*-{
